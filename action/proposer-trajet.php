...
if(!$error) {
	...
	if($stmt->execute(array($date->format('Y-m-d H:i').':00', htmlspecialchars(strtoupper($_POST['ville_a'])), htmlspecialchars(strtoupper($_POST['ville_d'])), $_POST['place'], $_POST['prix'], $_SESSION['UID']))) {
